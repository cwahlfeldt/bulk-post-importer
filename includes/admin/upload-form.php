...
<div class="wrap">
	...
	<form method="post" enctype="multipart/form-data" action="<?php echo esc_url(admin_url('tools.php?page=' . BPI_PLUGIN_SLUG)); ?>">
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					<input type="file" id="bpi_json_file" name="bpi_json_file" accept=".json,.csv,application/json,text/csv" required />
					<p class="description">
			...
			<tr valign="top">
				...
				<td>
					<select id="bpi_post_type" name="bpi_post_type" required>
		...
		<?php submit_button(__('Upload and Proceed to Mapping', 'bulk-post-importer'), 'primary', 'bpi_upload_json'); ?>
	</form>
</div>